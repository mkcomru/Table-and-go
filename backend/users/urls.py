...
from .views import RegisterView, CustomTokenObtainPairView, ProfileView, CheckInvitationView, CompleteInvitationView, ResendInvitationView, CancelInvitationView, ChangePasswordView
