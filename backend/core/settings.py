...
INSTALLED_APPS = [
    ...
    # 'django_daisy', pip install django-daisy
    'django.contrib.admin',
    # 'django.contrib.humanize', pip install django-daisy
    'django.contrib.auth',
...
# Проверяем наличие настроек PostgreSQL в переменных окружения
...
# Если есть все необходимые настройки для PostgreSQL, используем его
